...
class ChatConfigResponse(BaseModel):
    ...
    updated_at: datetime = Field(..., description="Chat config updated at")
...
class ChatMessageResponse(BaseModel):
    ...
    updated_at: datetime = Field(..., description="Chat message updated at")
...
class ChatSessionResponse(BaseModel):
    ...
    updated_at: datetime = Field(..., description="Chat session updated at")
    messages: ChatMessageListResponse = Field(..., description="List of chat messages")
